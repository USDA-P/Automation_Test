...
public class TestMppBuildQuestionnaireTs12p extends TestCase {
  ...
  public void testMppBuildQuestionnaireTs12p() throws Exception {
    try {
      ...
      Actual_Text = webDriver
          .findElement(By.xpath("//div[@id='answers_have_redetermination_letter']/fieldset/h4"))
          .getText();
      Expected_Text =
      ...
      Actual_Text =
          webDriver.findElement(By.xpath("//div[@id='answers_mpp_completion_cert']/fieldset/p[2]"))
              .getText();
      Expected_Text =
          "Both the Protégé and the Mentor must complete the Mentor-Protégé Program training module.";
      assertEquals(Actual_Text, Expected_Text);
      // Click on the continue button without answering the question and
      ...
      wait.until(ExpectedConditions.elementSelectionStateToBe(
          By.xpath("//div[@id='answers_protege_biz_plan']/fieldset/h4"), false));
      Actual_Text = webDriver
      ...
      assertEquals(Actual_Text, Expected_Text);
      Actual_Text = webDriver
          .findElement(By.cssSelector("#answers_other_active_mpp_agreements > fieldset > h4"))
          .getText();
      Expected_Text =
          "Do you have any active Mentor-Protégé Agreements with the SBA or another federal agency, either as a protégé, or as a mentor to another business?";
      assertEquals(Actual_Text, Expected_Text);
      // Verify the detail meaning text.
      Actual_Text = webDriver
          .findElement(By.xpath("//div[@id='answers_protege_biz_plan']/fieldset/p[2]")).getText();
      Expected_Text =
          "View more information on completing a business plan on SBA’s website or find a local resource partner near you.";
      assertEquals(Actual_Text, Expected_Text);
      Actual_Text = webDriver
          .findElement(By.xpath("//div[@id='answers_other_active_mpp_agreements']/fieldset/p[2]"))
          .getText();
      Expected_Text =
          "To participate in the All Small Mentor-Protégé Program, a protégé may have no more than two mentors across SBA’s Mentor-Protégé programs. Mentors may have no more than three protégés. Reference: 13 CFR 124.520";
      assertEquals(Actual_Text, Expected_Text);
      // Click on the continue button without answering the question and
      // verify alert message.
      CoreUtils.clickContinue(webDriver);
      ...
      Actual_Text = webDriver
          .findElement(By.xpath("//div[@id='answers_protege_active_agreements']/fieldset/h4"))
          .getText();
      ...
      // webDriver.findElement(By.xpath("//input[@name='commit']")).click();<=========== Open when
      ...
      // Select agency.
      Actual_Text = webDriver
          .findElement(By.cssSelector("#answers_mpp_agreement_agency_1 > fieldset > h4")).getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      webDriver
          .findElement(By.xpath("//option[@value='National Aeronautics and Space Administration']"))
          .click();
      // Effective date
      Actual_Text = webDriver
      ...
      Actual_Text = webDriver
          .findElement(By.xpath("//div[@id='answers_mpp_agreement_naics_1']/fieldset/p[2]"))
          .getText();
      Expected_Text =
          "The NAICS codes listed above are the primary or secondary codes associated with your business in SAM.gov. You may update your SAM.gov profile to include an additional NAICS code if the correct NAICS is not listed. If you add a code to your SAM.gov profile, please wait 24 hours for us to receive the update and then return to continue your application.";
      assertEquals(Actual_Text, Expected_Text);
      ...
      Expected_Text =
          "Please upload copies of the active agreements in which you are involved and any other applicable documentation.";
      assertEquals(Actual_Text, Expected_Text);
      ...
      // Details.
      Actual_Text = webDriver
          .findElement(By.xpath("//div[@id='answers_mpp_agreement']/fieldset/p[2]")).getText();
      Expected_Text =
          "Download a Word template for a sample Mentor-Protégé Agreement and upload in PDF format.";
      assertEquals(Actual_Text, Expected_Text);
      // Attempt to commit and verify alert message.
      CoreUtils.clickContinue(webDriver);
